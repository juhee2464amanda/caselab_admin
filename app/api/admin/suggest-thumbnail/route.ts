...
const CATEGORY_HINT: Record<string, string> = {
  ...
  // 콘텐츠(케이스·트렌드) — 자료실과 같은 패널을 쓴다(TrackForm 우측 레일)
  case: 'AI 활용 실전 케이스(직접 해본 작업 과정과 후기)',
  trend: 'AI 트렌드 소식(새로 나온 모델·기능·업계 변화)',
  ebook: '유료 전자책 상품',
};

const SYSTEM = `당신은 콘텐츠 편집자를 돕는 이미지 리서처입니다.
한국어 자료·콘텐츠(프롬프트·가이드·도구 소개·케이스·트렌드)의 제목·설명·본문을 읽고, 목록 카드 썸네일로 쓸 **스톡 사진 검색어(영어)**를 만듭니다.
