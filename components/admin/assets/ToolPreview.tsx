...
import { ToolBodySchema, type ToolBody } from '@/lib/content/tool-body';
import { isPromptCategory, PROMPT_CATEGORY_LABELS } from '@/lib/content/prompt-body';
import { Editable } from '@/components/admin/content/Editable';
import { useRefine } from '@/components/admin/content/RefinePanel';
import { renderBlocks } from '@/lib/content/content-render';
