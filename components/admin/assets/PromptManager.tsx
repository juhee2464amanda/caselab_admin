...
import { ThumbnailField } from '@/components/admin/content/ThumbnailField';
import { ThumbnailSuggest } from '@/components/admin/content/ThumbnailSuggest';
import { RichTextarea } from '@/components/admin/content/RichTextarea';
import { GalleryField } from '@/components/admin/content/BlockListEditor';
import { createSupabaseBrowserClient } from '@/lib/supabase/client';
import { PROMPT_CATEGORIES, PROMPT_CATEGORY_LABELS, type PromptCategory } from '@/lib/content/prompt-body';
