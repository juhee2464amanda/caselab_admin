...
export const TRACK_EDGES: TrackEdge[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { name: '설명', need: '소개 2~3문장 + [전제조건]·[주의](해당될 때만)' },
      { name: '프롬프트 본문', need: '바로 실행되는 실물(채울 자리는 {{변수}})' },
      { name: '분류·출처', need: '사고하기/만들기/검증하기/다듬기 중 1개 + 출처 라벨·링크' },
    ],
    fits: '문서 속 프롬프트 예시·명령문(여럿이면 가장 강한 1개를 선별), 프롬프트 전문이 없으면 노하우를 복사 가능한 전문으로 재구성',
    cuts: '배경 이론·긴 맥락 설명(description 한 문단으로 압축), 프롬프트 쓰는 법 일반론(→가이드)',
    guide:
      '문서에 프롬프트가 여러 개면 가장 실전적인 1개를 골라 본체로. prompt 본문은 바로 붙여넣어 실행되는 완결형으로(문서의 원문을 살리되 다듬기). 사용법·주의는 본문에 섞지 말고 description의 [전제조건]·[주의] 블록으로.',
  },
  {
    track: 'guide',
