...
import type { SeedSource } from '@/lib/seeds/seed-sources';
...
export const BUCKETS: BucketProfile[] = [
  ...
  },
  {
    ...
    criteria:
      ...
      '원문이 엔지니어 대상이어도 비개발자 실무자가 쓸 각도로 번역되면 유효(그 각도가 안 보이면 fit을 크게 낮출 것). ' +
      '단 서버·래퍼를 먼저 구축해야만 쓸 수 있으면 제외. 도구 소개면 service, 프롬프트 쓰는 법 일반론이면 etc.',
